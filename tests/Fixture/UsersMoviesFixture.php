...
class UsersMoviesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_uniqueid' => ['type' => 'biginteger', 'length' => 50, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'user_uniqueid' => 1,
                'movie_id' => 1,
                'created_at' => '2020-07-26 17:00:33',
                'updated_at' => '2020-07-26 17:00:33',
            ],
        ];
        parent::init();
    }
